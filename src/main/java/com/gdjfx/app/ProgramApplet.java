...
public class ProgramApplet extends Application {
    ...
    Font igiari = Font.loadFont("file:src/main/java/com/gdjfx/app/assets/igiari.ttf", 18);
    ...
    public void initializeRoot() throws FileNotFoundException {
        imgFastMode = retrieveImage("src/main/java/com/gdjfx/app/assets/fastmode.png");
        imgSlowMode = retrieveImage("src/main/java/com/gdjfx/app/assets/slowmode.png");
        imgStatic = retrieveImagesFromRoot("src/main/java/com/gdjfx/app/assets/", "static1.png", "static2.png", "static3.png", "static4.png");
        ...
        root = new Pane();
        root.setBackground(new Background(new BackgroundImage(retrieveImage("src/main/java/com/gdjfx/app/assets/rainpark.jpg"), BackgroundRepeat.NO_REPEAT, BackgroundRepeat.NO_REPEAT, BackgroundPosition.CENTER, BackgroundSize.DEFAULT)));
