...
public class GdSlowScene extends GdSlowConsole implements ModeScene {
    ...
    Font suburga = Font.loadFont("file:src/main/java/com/gdjfx/app/assets/suburga.otf", 20);
    Font attorneyButtons = Font.loadFont("file:src/main/java/com/gdjfx/app/assets/attorneybuttons.ttf", 20);
    Font igiari = Font.loadFont("file:src/main/java/com/gdjfx/app/assets/igiari.ttf", 12);

    static double bgmVolume = 0.15, sfxVolume = 0.8; // <- Default volume values.
    /*Media bgmConfrontModerato = new Media(new File("src/main/java/com/gdjfx/app/assets/audio/bgm/confrontation_moderato.mp3").toURI().toString());
    MediaPlayer bgmPlayer = buildAudio(bgmConfrontModerato, bgmVolume, MediaPlayer.INDEFINITE);
    AudioClip sfxNewEvidence = new AudioClip(new File("src/main/java/com/gdjfx/app/assets/audio/sfx/new_evidence.wav").toURI().toString());
    AudioClip sfxSelectShort = new AudioClip(new File("src/main/java/com/gdjfx/app/assets/audio/sfx/select_short.wav").toURI().toString());
    AudioClip sfxSelectLong = new AudioClip(new File("src/main/java/com/gdjfx/app/assets/audio/sfx/select_long.wav").toURI().toString());
    AudioClip sfxCancel = new AudioClip(new File("src/main/java/com/gdjfx/app/assets/audio/sfx/cancel.wav").toURI().toString());
    AudioClip sfxCard = new AudioClip(new File("src/main/java/com/gdjfx/app/assets/audio/sfx/card.wav").toURI().toString());
    AudioClip sfxDollop = new AudioClip(new File("src/main/java/com/gdjfx/app/assets/audio/sfx/dollop.wav").toURI().toString());
    AudioClip sfxFocus = new AudioClip(new File("src/main/java/com/gdjfx/app/assets/audio/sfx/focus.wav").toURI().toString());
    AudioClip sfxDiceroll = new AudioClip(new File("src/main/java/com/gdjfx/app/assets/audio/sfx/diceroll.mp3").toURI().toString());
    AudioClip sfxPeepHigh = new AudioClip(new File("src/main/java/com/gdjfx/app/assets/audio/sfx/peep_high.wav").toURI().toString());
    AudioClip sfxPeepLow = new AudioClip(new File("src/main/java/com/gdjfx/app/assets/audio/sfx/peep_low.wav").toURI().toString());*/
    ...
    public void initializeRoot() throws FileNotFoundException {
      ...
      //  bgmSlider.slider.setOnMouseReleased(e -> playVolumedAudio(sfxPeepHigh, bgmVolume));
        ...
        Image imgVelvet = retrieveImage("src/main/java/com/gdjfx/app/assets/velvettable.png");
        ...
        root = new Pane();
        root.setBackground(new Background(new BackgroundImage(retrieveImage("src/main/java/com/gdjfx/app/assets/fmbackdrop_bl.jpg"), BackgroundRepeat.REPEAT, BackgroundRepeat.REPEAT, BackgroundPosition.CENTER, BackgroundSize.DEFAULT)));
    ...
    public void visualizeDice(Dice diceA, Dice diceB, Set<Node> roundAssets) throws FileNotFoundException {
        Image imgDiceI = retrieveImage("src/main/java/com/gdjfx/app/assets/dicei.png");
        Image imgDiceII = retrieveImage("src/main/java/com/gdjfx/app/assets/diceii.png");
        Image imgDiceIII = retrieveImage("src/main/java/com/gdjfx/app/assets/diceiii.png");
        Image imgDiceIV = retrieveImage("src/main/java/com/gdjfx/app/assets/diceiv.png");
        Image imgDiceV = retrieveImage("src/main/java/com/gdjfx/app/assets/dicev.png");
        Image imgDiceVI = retrieveImage("src/main/java/com/gdjfx/app/assets/dicevi.png");
    ...
    public void visualizeCard(Card card, Set<Node> roundAssets) throws FileNotFoundException {
        ...
        Image cardCover = ((int)(Math.random()*2) == 0) ? retrieveImage("src/main/java/com/gdjfx/app/assets/redCardCover.png") : retrieveImage("src/main/java/com/gdjfx/app/assets/blueCardCover.png");
        Image[] cardFaces = new Image[52];

        for (int i = 1; i <= 52; i++) {
            cardFaces[i-1] = retrieveImage("src/main/java/com/gdjfx/app/assets/cardfaces/card_" + i + ".png");
        }
